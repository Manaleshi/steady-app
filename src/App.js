  ...
  if (!user) return (
    <div style={{ fontFamily: "system-ui, sans-serif", background: "#f0ede8", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ maxWidth: 360, width: "100%", textAlign: "center" }}>
        <img src="/logo-steady.png" alt="Steady" style={{ width: 120, height: 120, borderRadius: 24, marginBottom: 16 }} />
  ...
  return (
    <div style={styles.wrap}>
      ...
      <div style={styles.homeHeader}>
        <img src="/logo-steady.png" alt="Steady" style={{ width: 80, height: 80, borderRadius: 16, marginBottom: 8 }} />
